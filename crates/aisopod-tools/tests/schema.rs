...
use aisopod_tools::schema::{ToolDefinition, to_anthropic_batch, to_anthropic_format, to_gemini_batch, to_gemini_format, to_openai_batch, to_openai_format};

#[test]
fn test_tool_definition_creation() {
    let tool = ToolDefinition::new("calculator", "A calculator tool", serde_json::json!({"type": "object"}));
...
fn test_to_anthropic_format_single_tool() {
    let tool = ToolDefinition::new("calculator", "A calculator", serde_json::json!({
        "type": "object",
        "properties": {
