...
## Acceptance Criteria
- [ ] `ProviderRegistry` struct is defined and exported.
- [ ] Providers can be registered and retrieved by ID.
- [ ] `list()` returns all registered providers.
- [ ] Model aliases can be registered and resolved to a provider/model pair.
- [ ] `resolve_model()` works for both direct provider IDs and aliases.
